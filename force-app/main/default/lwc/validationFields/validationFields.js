...
import isPortalUser from '@salesforce/apex/deleteProjectApplicationController.isPortalUser';


export default class validationFields extends NavigationMixin(LightningElement) {
    @api userId = Id;
    @api recordId;
    ...
    handleProjectNameChanges(event) {
        if (event.target.dataset.id == "projectName") {
            this.projectName = event.target.value;
            console.log('projectName-> ', this.projectName);
        }
    }
    handleOrgNameFieldChanges(event) {
        if (event.target.dataset.id == "fullOrgName") {
    ...
    handleFieldChanges(event) {
        ...
        if (event.target.dataset.id == "teamCaptain") {
            this.teamCaptain = event.target.value;
        } else if (event.target.dataset.id == "surname") {
            this.surname = event.target.value;
        } else if (event.target.dataset.id == "firstName") {
            this.firstName = event.target.value;
            console.log('this.firstName ', this.firstName);
        } else if (event.target.dataset.id == "jobTitle") {
            this.jobTitle = event.target.value;
        } else if (event.target.dataset.id == "workEmail") {
            this.workEmail = event.target.value;
        } else if (event.target.dataset.id == "homeOfficeCity") {
            this.homeOfficeCity = event.target.value;
        } else if (event.target.dataset.id == "homeOfficeCountry") {
        ...
        } else if (event.target.dataset.id == "otherHomeOfficeCountry") {
            this.otherHomeOfficeCountry = event.target.value;
        } else if (event.target.dataset.id == "CompanyAffiliation") {
        ...
        } else if (event.target.dataset.id == "BusinessUnitAA") {
        ...
        } else if (event.target.dataset.id == "BusinessUnitDB") {
        ...
        } else if (event.target.dataset.id == "otherBusinessUnitDB") {
            this.otherBusinessUnitDB = event.target.value;
        } else if (event.target.dataset.id == "otherBusinessUnitAA") {
            this.otherBusinessUnitAA = event.target.value;
        } else if (event.target.dataset.id == "fullName") {
            this.fullName = event.target.value;
            console.log('this.fullName ',this.fullName);
        } else if (event.target.dataset.id == "noOfTeamMember") {
            this.noOfTeamMember = event.target.value;
        } else if (event.target.dataset.id == "websiteURL") {
            this.websiteURL = event.target.value;
        } else if (event.target.dataset.id == "isRegisteredEntity") {
            this.isRegisteredEntity = event.target.value;
            console.log('this.isRegisteredEntity ', this.isRegisteredEntity);

        } else if (event.target.dataset.id == "sectorActivites") {
        ...
        } else if (event.target.dataset.id == "geographicCoverage") {
            this.geographicCoverage = event.target.value;
        } else if (event.target.dataset.id == "targetBeneficiaries") {
        ...
        } else if (event.target.dataset.id == "partnerOrgComm") {
            this.partnerOrgComm = event.detail.value;
            console.log('this.partnerOrgComm', partnerOrgComm);
        } else if (event.target.dataset.id == "projectType") {
        ...
        } else if (event.target.dataset.id == "otherCountry") {
            this.otherCountry = event.target.value;
        } else if (event.target.dataset.id == "tm1FirstName") {
            this.tm1FirstName = event.target.value;
        } else if (event.target.dataset.id == "corpSocialInvst") {
        ...
        } else if (event.target.dataset.id == "otherSocialInvest") {
            this.otherSocialInvest = event.target.value;
        } else if (event.target.dataset.id == "alignMiningPlan") {
            this.alignMiningPlan = event.target.value;
        } else if (event.target.dataset.id == "howMuchFunding") {
            this.howMuchFunding = event.target.value;
        } else if (event.target.dataset.id == "workEmailLM") {
            this.workEmailLM = event.target.value;
            console.log('this.workEmailLM', workEmailLM);
        } else if (event.target.dataset.id == "tm1Surname") {
            this.tm1Surname = event.target.value;
        } else if (event.target.dataset.id == "tm1JobTitle") {
            this.tm1JobTitle = event.target.value;
        } else if (event.target.dataset.id == "tm1WorkEmail") {
            this.tm1WorkEmail = event.target.value;
        } else if (event.target.dataset.id == "tm1HomeOfficeCity") {
            this.tm1HomeOfficeCity = event.target.value;
        } else if (event.target.dataset.id == "tm1HomeOfficeCountry") {
        ...
        } else if (event.target.dataset.id == "tm1OtherHomeOfficeCountry") {
            this.tm1OtherHomeOfficeCountry = event.target.value;
        } else if (event.target.dataset.id == "tm1CompanyAffiliation") {
        ...
        } else if (event.target.dataset.id == "tm1BusinessUnitAA") {
        ...
        } else if (event.target.dataset.id == "tm1BusinessUnitDB") {
        ...
        } else if (event.target.dataset.id == "tm1OtherBusinessUnitAA") {
            this.tm1OtherBusinessUnitAA = event.target.value;
        } else if (event.target.dataset.id == "tm1OtherBusinessUnitBB") {
            this.tm1OtherBusinessUnitBB = event.target.value;
        } else if (event.target.dataset.id == "tm1MfullName") {
            this.tm1MfullName = event.target.value;
        } else if (event.target.dataset.id == "tm1MfullName") {
            this.tm1MfullName = event.target.value;
        } else if (event.target.dataset.id == "tm1MworkEmailLM") {
            this.tm1MworkEmailLM = event.target.value;
        } else if (event.target.dataset.id == "participatedBefore") {
            this.participatedBefore = event.target.value;
        } else if (event.target.dataset.id == "street") {
            this.street = event.target.value;
        } else if (event.target.dataset.id == "cityTown") {
            this.cityTown = event.target.value;
        } else if (event.target.dataset.id == "stateProvCountry") {
            this.stateProvCountry = event.target.value;
        } else if (event.target.dataset.id == "postCode") {
            this.postCode = event.target.value;
        } else if (event.target.dataset.id == "country") {
            this.country = event.target.value;
        } else if (event.target.dataset.id == "otherCountry") {
            this.otherCountry = event.target.value;
        } else if (event.target.dataset.id == "firstNamePOC") {
            this.firstNamePOC = event.target.value;
        } else if (event.target.dataset.id == "surnamePOC") {
            this.surnamePOC = event.target.value;
        } else if (event.target.dataset.id == "titlePOC") {
            this.titlePOC = event.target.value;
        } else if (event.target.dataset.id == "workEmailPOC") {
            this.workEmailPOC = event.target.value;
        } else if (event.target.dataset.id == "phoneNumberPOC") {
            this.phoneNumberPOC = event.target.value;
        } else if (event.target.dataset.id == "missionAndVision") {
            this.missionAndVision = event.target.value;
        } else if (event.target.dataset.id == "otherSectorAC") {
            this.otherSectorAC = event.target.value;
        } else if (event.target.dataset.id == "geographicCoverage") {
            this.geographicCoverage = event.target.value;
        } else if (event.target.dataset.id == "otherTargetBenef") {
            this.otherTargetBenef = event.target.value;
        } else if (event.target.dataset.id == "levelOfCommitment") {
            this.levelOfCommitment = event.target.value;
        } else if (event.target.dataset.id == "projectObjective") {
            this.projectObjective = event.target.value;
        } else if (event.target.dataset.id == "projectBackground") {
            this.projectBackground = event.target.value;
        } else if (event.target.dataset.id == "activitesToObtain") {
            this.activitesToObtain = event.target.value;
        } else if (event.target.dataset.id == "activitesToObtain") {
            this.activitesToObtain = event.target.value;
        } else if (event.target.dataset.id == "projectSustainability") {
            this.projectSustainability = event.target.value;
        } else if (event.target.dataset.id == "teamSkills") {
            this.teamSkills = event.target.value;
        } else if (event.target.dataset.id == "levelOfEffort") {
            this.levelOfEffort = event.target.value;
        } else if (event.target.dataset.id == "teamDiversity") {
            this.teamDiversity = event.target.value;
        } else if (event.target.dataset.id == "projectBeneficiaries") {
            this.projectBeneficiaries = event.target.value;
        } else if (event.target.dataset.id == "alignMiningPlan") {
            this.alignMiningPlan = event.target.value;
        } else if (event.target.dataset.id == "grantUse") {
            ...
            this.howMuchFunding = event.target.value;
        } else if (event.target.dataset.id == "grantNarrative") {
            this.grantNarrative = event.target.value;

        } else if (event.target.dataset.id == "tm2FirstName") {
            this.tm2FirstName = event.target.value;
        } else if (event.target.dataset.id == "tm2Surname") {
            this.tm2Surname = event.target.value;
        } else if (event.target.dataset.id == "tm2JobTitle") {
            this.tm2JobTitle = event.target.value;
        } else if (event.target.dataset.id == "tm2WorkEmail") {
            this.tm2WorkEmail = event.target.value;
        } else if (event.target.dataset.id == "tm2HomeOfficeCity") {
            this.tm2HomeOfficeCity = event.target.value;
        } else if (event.target.dataset.id == "tm2HomeOfficeCountry") {
        ...
        } else if (event.target.dataset.id == "tm2OtherHomeOfficeCountry") {
            this.tm2OtherHomeOfficeCountry = event.target.value;
        } else if (event.target.dataset.id == "tm2CompanyAffiliation") {
        ...
        } else if (event.target.dataset.id == "tm2BusinessUnitAA") {
        ...
        } else if (event.target.dataset.id == "tm2BusinessUnitDB") {
        ...
        } else if (event.target.dataset.id == "tm2OtherBusinessUnitAA") {
            this.tm2OtherBusinessUnitAA = event.target.value;
        } else if (event.target.dataset.id == "tm2OtherBusinessUnitDB") {
            this.tm2OtherBusinessUnitDB = event.target.value;
        } else if (event.target.dataset.id == "tm2MfullName") {
            this.tm2MfullName = event.target.value;
        } else if (event.target.dataset.id == "tm2MworkEmailLM") {
            this.tm2MworkEmailLM = event.target.value;

        } else if (event.target.dataset.id == "tm3FirstName") {
            this.tm3FirstName = event.target.value;
        } else if (event.target.dataset.id == "tm3Surname") {
            this.tm3Surname = event.target.value;
        } else if (event.target.dataset.id == "tm3JobTitle") {
            this.tm3JobTitle = event.target.value;
        } else if (event.target.dataset.id == "tm3WorkEmail") {
            this.tm3WorkEmail = event.target.value;
        } else if (event.target.dataset.id == "tm3HomeOfficeCity") {
            this.tm3HomeOfficeCity = event.target.value;
        } else if (event.target.dataset.id == "tm3HomeOfficeCountry") {
        ...
        } else if (event.target.dataset.id == "tm3OtherHomeOfficeCountry") {
            this.tm3OtherHomeOfficeCountry = event.target.value;
        } else if (event.target.dataset.id == "tm3CompanyAffiliation") {
        ...
        } else if (event.target.dataset.id == "tm3BusinessUnitAA") {
        ...
        } else if (event.target.dataset.id == "tm3BusinessUnitDB") {
        ...
        } else if (event.target.dataset.id == "tm3OtherBusinessUnitAA") {
            this.tm3OtherBusinessUnitAA = event.target.value;
        } else if (event.target.dataset.id == "tm3OtherBusinessUnitDB") {
            this.tm3OtherBusinessUnitDB = event.target.value;
        } else if (event.target.dataset.id == "tm3MfullName") {
            this.tm3MfullName = event.target.value;
        } else if (event.target.dataset.id == "tm3MworkEmailLM") {
            this.tm3MworkEmailLM = event.target.value;
        } else if (event.target.dataset.id == "tm4FirstName") {
            this.tm4FirstName = event.target.value;
        } else if (event.target.dataset.id == "tm4Surname") {
            this.tm4Surname = event.target.value;
        } else if (event.target.dataset.id == "tm4JobTitle") {
            this.tm4JobTitle = event.target.value;
        } else if (event.target.dataset.id == "tm4WorkEmail") {
            this.tm4WorkEmail = event.target.value;
        } else if (event.target.dataset.id == "tm4HomeOfficeCity") {
            this.tm4HomeOfficeCity = event.target.value;
        } else if (event.target.dataset.id == "tm4HomeOfficeCountry") {
        ...
        } else if (event.target.dataset.id == "tm4OtherHomeOfficeCountry") {
            this.tm4OtherHomeOfficeCountry = event.target.value;
        } else if (event.target.dataset.id == "tm4CompanyAffiliation") {
        ...
        } else if (event.target.dataset.id == "tm4BusinessUnitAA") {
        ...
        } else if (event.target.dataset.id == "tm4BusinessUnitDB") {
        ...
        } else if (event.target.dataset.id == "tm4OtherBusinessUnitAA") {
            this.tm4OtherBusinessUnitAA = event.target.value;
        } else if (event.target.dataset.id == "tm4OtherBusinessUnitDB") {
            this.tm4OtherBusinessUnitDB = event.target.value;
        } else if (event.target.dataset.id == "tm4MfullName") {
            this.tm4MfullName = event.target.value;
        } else if (event.target.dataset.id == "tm4MworkEmailLM") {
                ...
                if (result === 'Success') {
                    if(isPortal){
                        ...
                        this[NavigationMixin.Navigate]({
                            ...
                            attributes: {
                                recordId: this.projectApplicationId,
                                objectApiName: 'Application_Survey_Form__c',
                                actionName: 'view'
                            }
                        });
                    }
